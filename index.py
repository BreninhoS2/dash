            ...
            dbc.Card([
                dbc.CardBody([
                    dbc.Row([
                        dbc.Col([  
                           html.Legend([
                                html.Span("Panasonic", style={'font-size': '27px'}),
                                html.Br(),
                                html.Span("DashBoard", style={'font-size': '23px'})
                            ], style={'white-space': 'nowrap'})  # Ajuste do tamanho das fontes e quebra de linha
                        ], sm=8),
                        dbc.Col([        
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.Legend("Panasonic")
                        ])
                    ], style={'margin-top': '10px'}),
                    dbc.Row([
                        dbc.Button("Visite o Site", href="https://Panasonic.com/", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
